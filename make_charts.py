  ...
  <div class="section-header">
    ...
    <div class="section-controls">
      <div class="filter-group" id="subscribe-filter">
        <button class="filter-btn"        onclick="filterSection('subscribe',13,this)">최근 1년</button>
        ...
        <button class="filter-btn active" onclick="filterSection('subscribe',1,this)">최근 1개월</button>
      </div>
  ...
  <div class="section-header">
    ...
    <div class="section-controls">
      <div class="filter-group" id="trend-filter">
        <button class="filter-btn"        onclick="filterSection('trend',13,this)">최근 1년</button>
        ...
        <button class="filter-btn active" onclick="filterSection('trend',1,this)">최근 1개월</button>
      </div>
...
// ── 섹션 초기 빌드 ────────────────────────────────────
const FILTER_LABELS = {{ 13: '1년전', 6: '6개월전', 3: '3개월전', 1: '1개월전' }};
...
// ── 초기 렌더 ────────────────────────────────────────
buildSection('trend',     trendData,     1);
buildSection('subscribe', subscribeData, 1);
</script>
</body>
</html>""".format(
        date=today_str,
